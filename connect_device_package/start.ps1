...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a3vdljyadn7z3b-ats.iot.us-east-2.amazonaws.com --ca_file root-CA.crt --cert Test.cert.pem --key Test.private.key --client_id basicPubSub --topic sdk/test/python --count 0